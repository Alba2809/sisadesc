...
function Subjects() {
  ...
  const handleDeleteObject = () => {
    try {
      if (objectToDelete) deleteSomething(objectToDelete, "subject");
      handleDialog("");
      setLoading(true);
    } catch (error) {
      handleDialog("");
          ...
          <table className="table-auto w-full min-w-[800px] relative">
            <thead className="h-[50px] bg-[#f8f9fb] font-serif font-semibold">
              <tr>
                ...
                <th className="text-start px-2 min-w-[100px]">Nombre</th>
                <th className="text-start px-2 min-w-[100px]">
                  Código
                </th>
                            ...
                            >
                              <div className=" flex gap-3 items-center justify-center">
                                <Link
                                  ...
                                  onMouseEnter={() =>
                                    setIsHoverEdit(object.subjectid)
                                  }
                                  onMouseLeave={() => setIsHoverEdit(0)}
                                  to={`/admin/subjects/edit/${object._id}`}
                                >
                                  <FiEdit2
                                    color={
                                      isHoverEdit === object.subjectid
                                        ? "white"
                                        : "black"
                                    }
                                  />
                                ...
                                <button
                                  className="bg-[#f7f7fa] hover:bg-[#3d5ee1] w-[30px] h-[30px] rounded-full flex justify-center items-center"
                                  onMouseEnter={() =>
                                    setIsHoverDelete(object.subjectid)
                                  }
                                ...
                                >
                                  <RiDeleteBin6Line
                                    color={
                                      isHoverDelete === object.subjectid
                                        ? "white"
                                        : "black"
                                    }
                                  />
