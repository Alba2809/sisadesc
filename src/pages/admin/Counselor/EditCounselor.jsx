...
function EditCounselor() {
  ...
  const { getCounselor, handleGradeChange, handleGroupChange, counselorSelected, loading } = useCounselor({ setValue })
  const params = useParams()
  
  useEffect(() => {
    getCounselor(params.id)
  }, [])

  return (
    <div className="w-full h-full flex flex-col">
      <header className="h-[50px]">
        <h1 className="font-medium font-serif text-2xl">Editar asignación</h1>
      </header>
