...
function EditParent() {
  ...
  const { suggestions, handleChangeCP, handleSelectAddress } = useAddress({
    setValue,
  });
  const {
    loading,
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    const res = await updateParent(object.id, data);
                ...
                <div className="relative flex-1 lg:min-w-[30%] sm:min-w-[48%] md:min-w-[48%]">
                  ...
                  <input
                    ...
                    {...register("postalcode", {
                      ...
                      pattern: {
                        value: /^[0-9]+$/,
                        message: "Solo se permiten números en el código postal",
                      },
                      maxLength: {
                        value: 5,
                        message:
